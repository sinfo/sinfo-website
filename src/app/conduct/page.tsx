        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p>
            ...
            <a
              ...
              className="text-sinfo-primary hover:underline"
            >
              geral@sinfo.org
            </a>
            .
          ...
          <p>
            ...
            from the conference at the discretion of the conference organisers.
          </p>
          ...
          <p>
            ...
            and appropriate manner. Conference participants violating these
            rules may be sanctioned or expelled from the conference, without a
            refund, at the discretion of the conference organisers. Harassment
            includes verbal comments that reinforce social structures of
            ...
            harassing behaviour are expected to comply immediately. Sponsors are
            ...
            of the SINFO staff immediately. SINFO staff can be identified as
            they&apos;ll be wearing branded t-shirts. SINFO staff will be happy
